    ...
    <div className={s.footer}>
      <div className={s.footerInfo}>
        <div className={s.footerColumn}>
          <img src={logo} alt="knuckless" />
          <p>
            The Social Network. <br /> 2023.
          </p>
          <ul>
            <li>
        ...
        <div className={s.footerColumn}>
          ...
          <ul>
            <li>
              <FontAwesomeIcon icon={faTelegram} size="lg" pull="left" />
              <a href={'https://t.me/knucknuck'}>Telegram</a>
            </li>
            <li>
              <FontAwesomeIcon icon={faLinkedinIn} size="lg" pull="left" />
              <a
                href={
                  'https://www.linkedin.com/in/%D0%BA%D0%BE%D1%81%D1%82%D1%8F-%D0%BA%D0%BE%D1%85%D0%B0%D0%BD%D0%BE%D0%B2-776440245'
                }
              >
                LinkedIn
              </a>
            ...
            <li>
              ...
              <a href={'https://github.com/KnucKostya'}>GitHub</a>
            </li>
          </ul>
        </div>
        <div className={s.footerColumn}>
      ...
      <div className={s.reserved}>
        <p>
          {' '}
          ©Knuckless 2023. All rights reserved.
